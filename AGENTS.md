...
1. Read the module's own `AGENTS.md` (every module directory has one) and **update it on exit**. That file is how parallel agents and humans stay coherent across sessions.
