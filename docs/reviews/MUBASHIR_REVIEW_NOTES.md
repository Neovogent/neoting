...
**✅ RESOLVED (5 Sep 2026, the channel-provenance package — the derivation option, no `DocumentChannel` enum change needed).**
...
**✅ RESOLVED (5 Sep 2026, the channel-provenance package).**
...
**✅ RESOLVED (5 Sep 2026, the channel-provenance package — gaps 2 and 3; 4 stays with Shakib as scope).**
