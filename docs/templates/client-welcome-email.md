...
4. **The legal documents are published.** This email points to commitments the Terms of Service and Privacy Notice carry. Both are **version 1.0, solicitor-approved and in force from 11 September 2026**, and both render at `/legal/*`. If the Terms move to a new version, check that what this email promises still matches before the next send.
