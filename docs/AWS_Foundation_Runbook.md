...
Subordinate to the source-of-truth pair (SoT v1.3 · Governance v1.3) and the Team Engineering Guideline v1.1. It changes no locked decision; where it appears to, the pair wins and this file is wrong.
