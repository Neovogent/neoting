...
| Who decides what happens to it | **Neovogent** | **The accounting practice** |
...
**4.2 Our role.** For all of this, **the practice is the controller and Neovogent is the processor**. We act only on the practice's documented instructions. We do not decide what to collect, we do not use it for our own purposes, and we do not sell it or share it with anyone except the sub-processors listed in clause 6.
...
**5.5 Marketing.** [PLACEHOLDER: confirm whether Neovogent sends marketing email. If it does, state the lawful basis — consent, or the soft opt-in for existing customers — and how to unsubscribe. If it does not, replace this clause with "We do not send marketing email."]
