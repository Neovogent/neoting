  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center bg-ground text-center p-10">
      ...
      <p className="text-zinc-400 max-w-lg leading-relaxed font-medium">
        This section is part of the Document Workflow scope but hasn't been fully mocked up in this prototype iteration. Use the <strong className="text-brand">AI Workspace</strong>, <strong className="text-brand">Clients</strong>, <strong className="text-brand">Inboxes</strong>, or <strong className="text-brand">Chases</strong> tabs to explore active features.
      </p>
    </div>
  );
}
