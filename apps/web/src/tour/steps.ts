...
const m = {
  ...
  welcomeBody: 'In about five minutes you will see every screen — clients, inboxes, chasing, approvals, exporting for VT, and the portal your clients use. One idea runs through all of it: anything you can click, you can also just ask for in the chat.',
  ...
  chatAddClientBody: 'Two paths: send the client a registration link (they fill in their own company details), or register them yourself. The same intake the Clients screen uses.',
  ...
  clientsAddBody: 'Send them a registration link by email — they add their own details — or register them on their behalf. No connections are asked for, ever.',
  ...
  clientHeaderBody: 'Health and deadlines in the header; Ask AI and Chase always one tap away.',
  clientHeaderAsk: 'Tell me about American Burger',
  clientTabsTitle: 'Thirteen tabs, one pipeline',
  clientTabsBody: 'Overview, then the two inboxes (Costs and Sales), Bank, statements and claims, Approvals, Documents, Chases, Tasks, Users, Settings and the client-scoped AI chat. They scroll sideways on a phone.',
  ...
  bankAccountsBody: 'Each account on file, its balance, and how current its statements are. Uploaded statements are the source — nothing connects to the bank.',
  ...
  clientApprovalsBody: 'Pending items with approve, edit and reject on each row, and the workflows that route them — including client-side stages approved from an emailed link.',
  ...
  inboxesPublishTitle: 'Release for export',
  inboxesPublishBody: 'Releasing asks first and shows exactly what goes and what is held back. Approve, and the documents are Published — approved and ready for the VT import file, source documents and all.',
  inboxesPublishAsk: 'Publish everything that is ready',
  chasesTitle: 'Missing evidence, practice-wide',
  chasesBody: 'How much is missing, how many chases are live, and what is overdue. Chasing is by email, with quiet hours and a cooldown between messages.',
  ...
  workflowsBody: 'Multi-stage, conditional, with client-side stages approved from an emailed link. Describe a workflow in words and it is built for you — then edit by hand.',
  ...
  settingsBody: 'Profile, extraction, automation, chasing, approvals, exports, lists, AI guidance, communication, security.',
  settingsAutomationTitle: 'Automation',
  settingsAutomationBody: 'Auto-categorisation, whether AI suggestions apply themselves, archiving after release, and the bank-match tolerances.',
  ...
  portalSettingsBody: 'Business details, notifications, and their people — who at the business can send documents.',
  doneTitle: 'That is the whole loop',
  doneBody: 'Capture → extract → review → approve → export for VT → reconcile the bank → chase what is missing. Every screen you just saw is a shortcut; the chat can do all of it. Try asking something.',
};
