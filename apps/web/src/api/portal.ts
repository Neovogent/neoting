...
const documentUploadShape = z.object({
...
/**
 * Step two: the bytes, straight to object storage.
 *
 ...
 * headers are sent verbatim for the same reason.
 *
 ...
 */
async function putBytes(intent: DocumentUpload, bytes: Blob): Promise<void> {
