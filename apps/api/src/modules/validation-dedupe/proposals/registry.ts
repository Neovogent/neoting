 ...
 *
 * Eight real executors, four honest holes: a registry with named
 ...
 * `bank.confirm-match` in METH S11, `rule.create` in METH S13 (#142) and
 * `document.revoke-link` in launch stage A8; the remaining #81 four
 * (`move-business`, `reprocess`, `reject`, `split`) each need their own issue.
 *
