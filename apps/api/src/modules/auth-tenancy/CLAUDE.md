...
routed from `SignupChainController` — which now serves **seven** operations
(five, plus the forgotten-password pair below), because becoming a usable
account is one problem reached through several doors.
