...
function env(overrides: Partial<Env> = {}): Env {
  return Object.freeze({
    ...
    LEDGER_ADAPTER: 'demo', LEDGER_SANDBOX: true, INTEGRATION_TOKEN_KEY: '', XERO_CLIENT_ID: '', XERO_CLIENT_SECRET: '', XERO_REDIRECT_URI: '', QBO_CLIENT_ID: '', QBO_CLIENT_SECRET: '', QBO_REDIRECT_URI: '', SAGE_CLIENT_ID: '', SAGE_CLIENT_SECRET: '', SAGE_REDIRECT_URI: '', FREEAGENT_CLIENT_ID: '', FREEAGENT_CLIENT_SECRET: '', FREEAGENT_REDIRECT_URI: '',
    AI_CHAT: 'demo',
