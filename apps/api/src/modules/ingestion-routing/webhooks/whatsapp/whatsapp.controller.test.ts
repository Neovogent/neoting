...
const env: Env = Object.freeze({
  ...
  IMAGE_NORMALISER: 'fixture', DOCUMENT_GUARD: 'fixture', EXTRACTOR: 'demo', SMS_SENDER: 'demo', PORTAL_LINK_SECRET: '', PORTAL_SESSION_SECRET: '', S3_ENDPOINT: '', S3_REGION: 'eu-west-2',
