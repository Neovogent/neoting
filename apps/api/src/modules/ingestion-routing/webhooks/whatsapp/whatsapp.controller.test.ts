...
const env: Env = Object.freeze({
  ...
  AUTH_MODE: 'fixture', SESSION_SECRET: 'test-session-secret', APP_ORIGIN: 'https://app.test', SMS_REGION: 'eu-west-2', SMS_ORIGINATION_IDENTITY: '', OTP_MODE: 'demo', UPLOAD_URL_SECRET: 'test-secret', UPLOAD_URL_TTL_SECONDS: 900, SMTP_HOST: 'localhost', SMTP_PORT: 1025,
  ...
  LEDGER_ADAPTER: 'demo', LEDGER_SANDBOX: true, INTEGRATION_TOKEN_KEY: '', XERO_CLIENT_ID: '', XERO_CLIENT_SECRET: '', XERO_REDIRECT_URI: '', QBO_CLIENT_ID: '', QBO_CLIENT_SECRET: '', QBO_REDIRECT_URI: '', SAGE_CLIENT_ID: '', SAGE_CLIENT_SECRET: '', SAGE_REDIRECT_URI: '', FREEAGENT_CLIENT_ID: '', FREEAGENT_CLIENT_SECRET: '', FREEAGENT_REDIRECT_URI: '', AI_CHAT: 'demo', AI_DAILY_BUDGET_PENCE: 500, SMS_SENDER: 'demo', PORTAL_LINK_SECRET: '', PORTAL_SESSION_SECRET: '', S3_ENDPOINT: '', S3_REGION: 'eu-west-2',
  EMAIL_SENDER: 'demo', SES_REGION: 'eu-west-2', EMAIL_FROM_ADDRESS: 'no-reply@neoting.neovogent.com', EMAIL_REPLY_TO_ADDRESS: 'hello@neovogent.com', EMAIL_CONFIGURATION_SET: '', EMAIL_RATE_LIMIT: 'memory',
  BILLING: 'demo', STRIPE_SECRET_KEY: '', STRIPE_WEBHOOK_SECRET: '', STRIPE_PRICE_ID: '', STRIPE_VAULT_PRICE_ID: '', GOOGLE_DRIVE_CLIENT_ID: '', GOOGLE_DRIVE_CLIENT_SECRET: '', GOOGLE_DRIVE_REDIRECT_URI: '', ONEDRIVE_CLIENT_ID: '', ONEDRIVE_CLIENT_SECRET: '', ONEDRIVE_REDIRECT_URI: '',
