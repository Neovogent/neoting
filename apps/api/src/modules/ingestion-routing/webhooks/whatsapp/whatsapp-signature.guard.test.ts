...
const env: Env = Object.freeze({
  ...
  IMAGE_NORMALISER: 'fixture', DOCUMENT_GUARD: 'fixture', EXTRACTOR: 'demo', LEDGER_ADAPTER: 'demo', AI_CHAT: 'demo', BEDROCK_REGION: 'eu-west-2', AI_DAILY_BUDGET_PENCE: 500, SMS_SENDER: 'demo', PORTAL_LINK_SECRET: '', PORTAL_SESSION_SECRET: '', S3_ENDPOINT: '', S3_REGION: 'eu-west-2',
